...
function ProductList() {
    ...
    const handleAddToCart=(plant)=>{
        ...
        setCartButtonDisable(!cartButtonDisable);
    }
    useEffect(() => setCartQuantity(Object.keys(cart).length));
    const plantsArray = [
        {
            ...
            <div style={styleObjUl}>
                ...
                <div> <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                    <h1 className='cart'>
                        ...
                        <text x="100" y="155" class="heavy" color='white'>{cartQuantity}</text>
                        </svg>
                    </h1></a></div>
            </div>
        </div>
                ...
                <div className="product-list">
                    {category.plants.map((plant,plantIndex) => (
                        <div class="product-card" key={plantIndex}>
                            ...
                            disabled={cartButtonDisable} onClick={() => handleAddToCart(plant)}>Add to Cart</button>
                        </div> 
                    ))}
                </div>
                </div>
